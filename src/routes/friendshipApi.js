...
import { validateFriendRequest, validateFriendResponse } from '../middleware/validateRequest.js';

const routerFriendship = express.Router();

routerFriendship.post('/request', 
    authMiddleware, 
    validateFriendRequest, 
    sendFriendRequest
);

routerFriendship.post('/respond/:requestId', 
    authMiddleware, 
...
routerFriendship.get('/requests/received', authMiddleware, getReceivedFriendRequests);
